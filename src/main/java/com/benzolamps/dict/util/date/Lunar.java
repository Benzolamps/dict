...
public class Lunar {
    ...
    public Lunar(Date date) {
        ...
        for (iYear = 1900; iYear < LUNAR_INFO.length + 1900
                && offset > 0; iYear++) {
    ...
    public static String getDayStr(int day) {
        switch (day) {
            ...
            default: {
                switch (day / 10) {
                    case 0:
                        return "初" + CHINESE_NUMBER[day % 10 - 1];
                    case 1:
                        return "十" + CHINESE_NUMBER[day % 10 - 1];
                    case 2:
                        return "廿" + CHINESE_NUMBER[day % 10 - 1];
                }
            }
        }
        return null;
    ...
    public String toString() {
        return "农历" + getGanZhi() + getAnimal() + "年" + (isLeap ? "闰" : "") + MONTH_STR[month - 1] + "月" + getDayStr(day);
    }
    ...
    public String getMonthStr() {
        return (isLeap ? "闰" : "") + MONTH_STR[month - 1];
    }
