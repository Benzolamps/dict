...
public class Lunar {
    ...
    private final static String monthStr[] = {"正", "二", "三", "四", "五", "六",
            "七", "八", "九", "十", "冬", "腊"};
    ...
    public static String getDayStr(int day) {
        String chineseNumber[] = {"一", "二", "三", "四", "五", "六", "七", "八",
                "九"};
    ...
    public String toString() {
        return "农历" + getGanZhi() + getAnimal() + "年" + (isLeap ? "闰" : "")
                + monthStr[month - 1] + "月" + getDayStr(day);
    }
