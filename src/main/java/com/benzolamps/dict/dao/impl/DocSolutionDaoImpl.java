...
public class DocSolutionDaoImpl implements DocSolutionDao {
    ...
    @Value("#{T(com.benzolamps.dict.util.Constant).YAML.loadAs(new org.springframework.core.io.FileSystemResource('templates/doc/config.yml').inputStream, T(com.benzolamps.dict.bean.DocSolutions))}")
