...
var Lock = function () {
  ...
  _createClass(Lock, [{
    ...
    value: function onChange() {
      ...
      if (Lock.checkPassword(this.code)) {
        this.verified = true;
    ...
    value: function setupAudio() {
      ...
      this.sounds.select = new Howl({
        src: ['${base_url}/flickity/sounds/lock-button-1.mp3', '${base_url}/flickity/sounds/lock-button-1.ogg'],
        volume: 0.5,
        rate: 1.4
      });

      this.sounds.prev = new Howl({
        src: ['${base_url}/flickity/sounds/lock-button-4.mp3', '${base_url}/flickity/sounds/lock-button-4.ogg'],
        volume: 0.5,
        rate: 1
      });
      ...
      this.sounds.success = new Howl({
        src: ['${base_url}/flickity/sounds/lock-online-1.mp3', '${base_url}/flickity/sounds/lock-online-1.ogg'],
        volume: 0.5,
        rate: 1
      });

      this.sounds.fail = new Howl({
        src: ['${base_url}/flickity/sounds/lock-fail-1.mp3', '${base_url}/flickity/sounds/lock-fail-1.ogg'],
        volume: 0.6,
        rate: 1
      });
    }
    ...
    value: function setupFlickity() {
      ...
      var _loop = function _loop(i, len) {
        ...
        flkty.lastIndex = 0;
        flkty.select((Math.random() * 10) | 0, true, true);
