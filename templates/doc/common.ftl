...
<#assign cn_font_family = .globals['service.file_exported.chinese_font_family']/>
<#assign en_font_family = .globals['service.file_exported.english_font_family']/>
<#assign font_size = .globals['service.file_exported.font_size']/>
<#assign line_height = .globals['service.file_exported.line_height']/>
<#assign show_separators = .globals['service.file_exported.show_separators']/>
<#assign new_words_title = .globals['service.file_exported.new_words_title']/>
<#assign copy_words_title = .globals['service.file_exported.copy_words_title']/>
<#assign new_phrases_title = .globals['service.file_exported.new_phrases_title']/>
<#assign copy_phrases_title = .globals['service.file_exported.copy_phrases_title']/>
<#assign table_border_color = .globals['service.file_exported.table_border_color']/>
<#assign insert_blank_line_between_words = .globals['service.file_exported.insert_blank_line_between_words']/>
<#assign definition_arranges_vertically = .globals['service.file_exported.definition_arranges_vertically']/>
  ...
  <#list definations?split("；") as def>
    <w:p wsp:rsidR="00E602B2" wsp:rsidRPr="006C50AA" wsp:rsidRDefault="00E602B2" wsp:rsidP="00E602B2">
      <w:pPr>
        ...
        <w:jc w:val="left"/>
        <w:rPr>
          <w:rFonts w:ascii="${en_font_family}" w:fareast="${cn_font_family}" w:h-ansi="${en_font_family}"/>
          <wx:font wx:val="${en_font_family}"/>
...
<w:wordDocument
  ...
  w:macrosPresent="no" w:embeddedObjPresent="no" w:ocxPresent="no" xml:space="preserve" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://schemas.microsoft.com/office/drawing/2014/chartex ">
  <w:ignoreSubtree w:val="http://schemas.microsoft.com/office/word/2003/wordml/sp2"/>
  <o:DocumentProperties>
    <o:Author>${.globals['user.name']}</o:Author>
    <o:LastAuthor>${.globals['user.name']}</o:LastAuthor>
  ...
  <w:fonts>
    <w:defaultFonts w:ascii="等线" w:fareast="等线" w:h-ansi="等线" w:cs="${en_font_family}"/>
    <w:font w:name="${en_font_family}">
  ...
  <w:docPr>
    ...
    <w:footnotePr>
      <w:footnote w:type="separator">
        <w:p wsp:rsidR="0019750E" wsp:rsidRDefault="0019750E" wsp:rsidP="008757E1">
          <w:r>
            <w:separator/>
          </w:r>
        </w:p>
...
<#-- 标题 -->
<#macro title value>
   <w:p wsp:rsidR="009419D7" wsp:rsidRPr="00865152" wsp:rsidRDefault="0028394F" wsp:rsidP="0028394F">
     <w:pPr>
       <w:jc w:val="center"/>
       <w:rPr>
         <w:sz w:val="28"/>
   ...
   <w:p wsp:rsidR="0028394F" wsp:rsidRDefault="0028394F" wsp:rsidP="0028394F">
     <w:pPr>
       <w:jc w:val="center"/>
       <w:rPr>
       ...
       <w:sectPr wsp:rsidR="0028394F" wsp:rsidSect="00865152">
         <w:ftr w:type="odd">
           <w:p wsp:rsidR="00E74F26" wsp:rsidRPr="00865152" wsp:rsidRDefault="008757E1" wsp:rsidP="00865152">
             <w:pPr>
               <w:jc w:val="center"/>
               <w:rPr>
             ...
             <w:r wsp:rsidR="0019750E" wsp:rsidRPr="00E74F26">
               <w:rPr>
                 <w:rFonts w:ascii="Times New Roman" w:h-ansi="Times New Roman"/>
                 <wx:font wx:val="Times New Roman"/>
                 <w:b-cs/>
...
<#-- 分隔线 -->
<#macro line>
  <w:p wsp:rsidR="00433643" wsp:rsidRPr="0028394F" wsp:rsidRDefault="00433643" wsp:rsidP="0028394F">
    <w:pPr>
      <w:jc w:val="left"/>
      <w:rPr>
        <w:rFonts w:ascii="${en_font_family}" w:fareast="${cn_font_family}" w:h-ansi="${en_font_family}" w:hint="fareast"/>
        <wx:font wx:val="${en_font_family}"/>
        <w:sz w:val="${font_size}"/>
        <w:sz-cs w:val="${font_size}"/>
      </w:rPr>
  ...
  <w:sectPr wsp:rsidR="00433643" wsp:rsidRPr="0028394F" wsp:rsidSect="0028394F">
